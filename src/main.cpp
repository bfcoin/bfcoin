...
// Copyright (c) 2013 The BFCoin developers
...
uint256 hashGenesisBlock("0x00000b439de8a340c37a6edb0dceaa74a2f3338fb6883a4fb35b23cd173ea63b");
static const unsigned int timeGenesisBlock = 1468145888;
...
const string strMessageMagic = "BFCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "already in already ParseHex we BFCoin from USA with reindexing.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("05678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf12d6f") << OP_CHECKSIG;
        CBlock block;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x6f864d7a7fbd10a4a710c9ad6e1b77df996f2f1de253d074aa96dcc711ffc372"));
...
unsigned char pchMessageStart[4] = { 0x2d, 0x2D, 0xA3, 0xF1 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BFCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BFCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BFCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("BFCoin-miner");
    ...
    try { loop {
        ...
        printf("Running BFCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
