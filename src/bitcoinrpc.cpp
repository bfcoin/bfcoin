...
{
    return GetBoolArg("-testnet", false) ? 28338 : 52805;
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: BFCoin-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use BFCoind";
...
void JSONRequest::parse(const Value& valRequest)
{
    ...
    if (strMethod != "getwork" && strMethod != "getwork2" && strMethod != "-1.9")
