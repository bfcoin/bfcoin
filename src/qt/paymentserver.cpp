...
const QString BITCOIN_IPC_PREFIX("BFCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click BFCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start BFCoin: click-to-pay handler");
    else
...
{
    // clicking on BFCoin: URLs creates FileOpen events on the Mac:
